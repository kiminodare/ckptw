...
export default async function VipProofDashboard({
  searchParams,
}: DashboardProps) {
            ...
            <tbody>
              {data.map((proof: VipProof, idx: number) => (
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-3 sm:py-4 text-gray-800">
                    {proof.summitTotal}
                  </td>
                  <td className="px-4 sm:px-6 py-3 sm:py-4">
                  ...
                  <td className="px-4 sm:px-6 py-3 sm:py-4 text-center flex gap-2 justify-center">
                    {proof.status === "REJECTED" && (
                      <AppealModal proof={proof} />
                    )}
                    {(proof.status.toLowerCase() === "pending" ||
                      proof.status === "REJECTED") && (
                      <EditModal proof={proof} />
                    )}
                  </td>
                </tr>
              ))}
